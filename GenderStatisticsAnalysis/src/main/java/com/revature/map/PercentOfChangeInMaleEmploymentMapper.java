...
public class PercentOfChangeInMaleEmploymentMapper extends Mapper<LongWritable, Text, Text, MapWritable> {

	/*
	 * The map method selects records that contain the statement "labor force participation rate"
	 * and "female". It writes an intermediate output using a Text as a key
	...
	public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
		...
		boolean isEmployed = recordColumn[2].contains("labor force participation rate");
		boolean isMale = !recordColumn[2].contains("female");
